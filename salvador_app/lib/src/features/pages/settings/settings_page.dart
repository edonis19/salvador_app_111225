...
class SettingsView extends ConsumerWidget {
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              try {
                                ...
                                var data = await ref.read(itemsApiProvider
                                    .call(dataLimiteItem)
                                    .future);
                                ref
  ...
  void onDeleteAllClosedOrders(BuildContext context, WidgetRef ref, bool reset,
                            ...
                            onPressed: () async {
                              ...
                              try {
                                ...
                                ref
                                    .read(interventiStateRepositoryProvider
                                        .notifier)
                                    .removeAllInterventi(interventi, true);
            ...
            children: [
              ...
              _SingleSection(
                children: [
                  ...
                  const SizedBox(height: 10),
                  _CustomListTile(
                    title: "Pulisci dati gestionale",
                    icon: Icons.sync,
                    trailing: TextButton(
                      onPressed: () async {
                        onDeleteAllClosedOrders(
                          context,
                          ref,
                          false,
                          "Pulisci dati gestionale",
                          "Vuoi davvero eliminare gli interventi?",
                        );
                      },
                      child: const Text("Seleziona"),
                    ),
