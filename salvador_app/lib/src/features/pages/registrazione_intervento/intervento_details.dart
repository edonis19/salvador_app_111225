...
class InterventoDetailsSection extends ConsumerWidget {
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            ..._items.map((item) => _buildExpansionTile(
                intervento, item, context, ultimaModifica, ref)),
          ],
        ),
      ),
    );
  ...
  Widget _buildDataTable(Intervento intervento, List<String> subItems,
      BuildContext context, DateTime? ultimaModifica, WidgetRef ref) {
          ...
          TableRow(
            children: [
              ...
              _buildTableCell(context,
                  _buildValue(intervento, subItem, ultimaModifica, ref) ?? '',
  ...
  String? _buildValue(Intervento intervento, String subItem,
      DateTime? ultimaModifica, WidgetRef ref) {
  ...
  Widget _buildExpansionTile(Intervento intervento, ExpansionItem item,
      BuildContext context, DateTime? ultimaModifica, WidgetRef ref) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDataTable(
              intervento, item.subItems, context, ultimaModifica, ref),
        ],
      ),
    );
  }
