...
class ArticoliInterventoDataSource extends DataGridSource {
  ...
  Future<void> removeRiga(WidgetRef ref, int rigaNum) async {
    await ref.read(interventoApertoStateProvider.notifier).removeRiga(rigaNum);
  }
