...
class InterventiApertiDataSource extends DataGridSource {
  ...
  List<DataGridRow> get rows {
    ...
    rows.addAll(data
        .where((intervento) => intervento.status != 'CHI')
        .map((intervento) {
          ...
          actions: <Widget>[
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () async {
                    await _deleteIntervento(intervento);
  ...
  Future<void> _deleteIntervento(Intervento intervento) async {
    await ref
        .read(interventoApertoStateProvider.notifier)
